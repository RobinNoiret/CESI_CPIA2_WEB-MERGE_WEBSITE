<div class="landing">
    ...
    <div id="landing-pictureBG">
        <img id="picture" src="Assets/Picture backgroundhome-firstpicture.png">
    </div>
    ...
    <div class="landing-domains">
        ...
        <div class="domains">
            <div class="domain" id="domain-IT">
                ...
                <img class="domain-pictures" src="Assets/TechnologyIT.png">
                </a>
            ...
            <div class="domain" id="domain-services">
                ...
                <img class="domain-pictures" src="Assets/Serviceservice.png">
                </a>
            ...
            <div class="domain" id="domain-Health">
                ...
                <img class="domain-pictures" src="Assets/Health Care - Health Researchhealth.png">
                </a>
            ...
            <div class="domain" id="domain-Finances">
                ...
                <img class="domain-pictures" src="Assets/Business Planbusiness.svg">
                </a>
    ...
    <div class="landing-articles">
        <article class="articles-pict_right">
            ...
            <img class="article-picture" src="Assets/Placeholder imageexplorez et trouver votre voie.png">

        </article>

        <article class="articles-pict_left">
            <img class="article-picture" src="Assets/Placeholder imagedéveloppez votre réseau.png">
        ...
        <article class="articles-pict_right">
            ...
            <img class="article-picture" src="Assets/Placeholder imagepréparez vous.png">
        </article>
